...
Static prototype for the Haul Mart grocery navigation website.

Open `index.html` in a browser to use it. The app includes:

- Customer product navigation with product image cards, price, category, location, and stock status.
- Grocery checklist with product navigation from list items.
